...
SOURCES = \
	__init__.py \
	odk_geo_qgis_wkt.py odk_geo_qgis_wkt_dialog.py

PLUGINNAME = odk_geo_qgis_wkt

PY_FILES = \
	__init__.py \
	odk_geo_qgis_wkt.py odk_geo_qgis_wkt_dialog.py

UI_FILES = odk_geo_qgis_wkt_dialog_base.ui
...
QGISDIR=C:\Users\Junaid Abdul-Jabbar\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
